...
AddFiller("ui/human/filler1.png", 176 + 176, Video.Height - 136 - 24)
AddFiller("ui/human/buttonpanel.png", 176, Video.Height - 160)
AddFiller("ui/human/menubutton.png", Video.Width - 176, Video.Height - 136 - 24)
AddFiller("ui/human/statusline.png", 176, Video.Height - 160 - 16)
AddFiller("ui/human/minimap.png", Video.Width - 176, Video.Height - 136)
...
-- gold
UI.Resources[1].G = CGraphic:New(Wyrmsun .. "graphics/ui/gold.png", 14, 14)
...
-- wood
UI.Resources[2].G = CGraphic:New(Wyrmsun .. "graphics/ui/lumber.png", 14, 14)
...
-- food
if (CanAccessFile(Wyrmsun .. "graphics/ui/food.png")) then
  UI.Resources[FoodCost].G = CGraphic:New(Wyrmsun .. "graphics/ui/food.png", 14, 14)
else
