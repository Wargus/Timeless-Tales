...
DefineAnimations("animations-human-dead-body", {
  Death = {"unbreakable begin", "frame 0", "wait 20000", "frame 10", "wait 20000", "frame 15", "wait 20000",
    "frame 20", "wait 20000", "frame 25", "wait 20000", "frame 25", "unbreakable end", "wait 1",},
})
