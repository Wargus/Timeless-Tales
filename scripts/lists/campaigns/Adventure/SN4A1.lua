...
if (GameDefinition["Briefing"]["Active"] == true) then
	...
	GameDefinition["Map"]["Name"] = "Mission 4"
	GameDefinition["Map"]["File"] = "SN4A1"
	...
	BundleAction("Scrolling Text", "Sandria Fields", "campaigns/human-tales/level04h.txt")
elseif (GameDefinition["Briefing"]["Active"] == 1) then
	BriefingAction("Start", "campaigns/human-tales/level04h.smp")
