...
if (GameDefinition["Briefing"]["Active"] == true) then
	...
	GameDefinition["Map"]["Name"] = "Mission 5"
	GameDefinition["Map"]["File"] = "SN5A1"
	...
	BundleAction("Scrolling Text", "Sandria Fields", "campaigns/human-tales/level05h.txt")
elseif (GameDefinition["Briefing"]["Active"] == 1) then
	BriefingAction("Start", "campaigns/human-tales/level05h.smp")
elseif (GameDefinition["Briefing"]["Active"] == 2) then
	GameDefinition["Map"]["Player"] = 6
