...
if (GameDefinition["Briefing"]["Active"] == true) then
	...
	GameDefinition["Map"]["Name"] = "Mission 3"
	GameDefinition["Map"]["File"] = "SN3A1"
	...
	BundleAction("Scrolling Text", "Sandria Fields", "campaigns/human-tales/level03h.txt")
elseif (GameDefinition["Briefing"]["Active"] == 1) then
	BriefingAction("Start", "campaigns/human-tales/level03h.smp")
elseif (GameDefinition["Briefing"]["Active"] == 2) then
	...
	elseif (GameResult == GameDraw) then
		GameDefinition["Map"]["Name"] = "SN4A1"
		BundleAction("Chat", "Sandria Fields", "I'm not staying on this island for another moment! I'm returning to the mainland at once!")
	else
		GameDefinition["Map"]["Name"] = "SN4A1"
