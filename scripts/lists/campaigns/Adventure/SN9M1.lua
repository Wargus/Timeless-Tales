...
if (GameDefinition["Briefing"]["Active"] == true) then
	...
	GameDefinition["Map"]["Name"] = "Mission 9"
	GameDefinition["Map"]["File"] = "SN9M1"
	...
	BundleAction("Scrolling Text", "Sandria Fields", "campaigns/human-tales/level09n.txt")
elseif (GameDefinition["Briefing"]["Active"] == 1) then
	BriefingAction("Start", "campaigns/human-tales/level09n.smp")
