...
if (GameDefinition["Briefing"]["Active"] == true) then
	...
	GameDefinition["Map"]["Name"] = "Mission 1"
	GameDefinition["Map"]["File"] = "SN1A1"
	...
	BundleAction("Scrolling Text", "Sandria Fields", "campaigns/human-tales/level01h.txt")
elseif (GameDefinition["Briefing"]["Active"] == 1) then
	BriefingAction("Start", "campaigns/human-tales/level01h.smp")
elseif (GameDefinition["Briefing"]["Active"] == 2) then
	...
	elseif (GameResult == GameDraw) then
		GameDefinition["Map"]["Name"] = "SN2A1"
		BundleAction("Results", "Sandria Fields", "I'm not wasting my time chasing after rumours.")
	else
		GameDefinition["Map"]["Name"] = "SN2A1"
